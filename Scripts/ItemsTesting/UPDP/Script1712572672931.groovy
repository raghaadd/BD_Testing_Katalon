...
WebUI.click(findTestObject('Object Repository/Page_Alora Persimmon Floral Upholstery Fabr_25757f/button_In-stock usually ships in 1-7 busine_2d3f42'))

WebUI.click(findTestObject('Object Repository/Page_Alora Persimmon Floral Upholstery Fabr_25757f/button_Add To Cart'))

WebUI.click(findTestObject('Object Repository/Page_Alora Persimmon Floral Upholstery Fabr_25757f/button_Checkout'))
