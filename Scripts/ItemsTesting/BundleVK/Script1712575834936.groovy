...
WebUI.click(findTestObject('Object Repository/Page_Original Home Office Corner Desk with _bfcfeb/img_Select Style_gwt-image-picker-option-image'))

WebUI.click(findTestObject('Object Repository/Page_Original Home Office Corner Desk with _bfcfeb/button_Add To Cart'))

WebUI.click(findTestObject('Object Repository/Page_Original Home Office Corner Desk with _bfcfeb/button_Checkout'))

WebUI.click(findTestObject('Object Repository/Page_Shopping Cart  Ballard Designs/a_Edit'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_Shopping Cart  Ballard Designs/img_Gear Pull Brushed Nickel_gwt-image-pick_4e2018'))
